...
public abstract interface WeblogicPluginResources {
	...
	public static final String WEBLOGIC_DESCRIPTION_LABEL = WeblogicPlugin
			.getResourceString("pref.weblogic.description.label");
	public static final String WEBLOGIC_VERSION_LABEL = WeblogicPlugin.getResourceString("pref.weblogic.version.label");
	public static final String WEBLOGIC_ORACLEHOME_LABEL = WeblogicPlugin
			.getResourceString("pref.weblogic.oraclehome.label");
	public static final String WEBLOGIC_WLHOME_LABEL = WeblogicPlugin.getResourceString("pref.weblogic.wlhome.label");
	public static final String WEBLOGIC_DOMAINNAME_LABEL = WeblogicPlugin
			.getResourceString("pref.weblogic.domainname.label");
	public static final String WEBLOGIC_DOMAINDIR_LABEL = WeblogicPlugin
			.getResourceString("pref.weblogic.domaindir.label");
	public static final String WEBLOGIC_SERVERNAME_LABEL = WeblogicPlugin
			.getResourceString("pref.weblogic.servername.label");
	public static final String WEBLOGIC_USER_LABEL = WeblogicPlugin.getResourceString("pref.weblogic.user.label");
	public static final String WEBLOGIC_PASSWORD_LABEL = WeblogicPlugin
			.getResourceString("pref.weblogic.password.label");
	public static final String WEBLOGIC_HOSTNAME_LABEL = WeblogicPlugin
			.getResourceString("pref.weblogic.hostname.label");
	public static final String WEBLOGIC_PORT_LABEL = WeblogicPlugin.getResourceString("pref.weblogic.port.label");
	public static final String CLASSPATH_DESCRIPTION_LABEL = WeblogicPlugin
			.getResourceString("pref.classpath.description.label");
	...
	public static final String PROJECT_DESCRIPTION_LABEL = WeblogicPlugin
			.getResourceString("pref.project.description.label");
	public static final String PROJECT_LIST_LABEL = WeblogicPlugin.getResourceString("pref.project.list.label");
	public static final String PROJECT_SELECTION_LABEL = WeblogicPlugin
			.getResourceString("pref.project.selection.label");
	public static final String DEBUG_DESCRIPTION_LABEL = WeblogicPlugin
			.getResourceString("pref.debug.description.label");
