...
/**
 * This class represents Weblogic preference page that is contributed to the
...
public class WeblogicPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage, WeblogicPluginResources {
	...
	public void createFieldEditors() {
		...
		this.addField(new StringFieldEditor(PREF_REMOTE_START, WEBLOGIC_REMOTE_START_LABEL, 75, this.getFieldEditorParent()));
		this.addField(new StringFieldEditor(PREF_REMOTE_START_PORT, WEBLOGIC_REMOTE_START_PORT_LABEL, 10, this.getFieldEditorParent()));
		this.addField(new StringFieldEditor(PREF_REMOTE_STOP, WEBLOGIC_REMOTE_STOP_LABEL, 75, this.getFieldEditorParent()));
	}
	/*
	 * (non-Javadoc)
	 * 
